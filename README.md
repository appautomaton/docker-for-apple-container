...
- macOS 26 with Apple `container` 1.2.0 or newer
- The `container` apiserver running (check with `container system status`)

The current compatibility baseline is Apple `container` 1.2.0. The shim depends
...
baseline is Apple `container` 1.2.0.
